...
public class Main {
    public static void main(String[] args) {
        String text = "acceptancea, accomplice, accordance, accountancy, accuracy, acquiescencea, " +
                ...
                "cockroaches, cocksucker, coincidence, acceptancea colchicine, complacency, concentric, concoction, " +
                ...
                "spectroscopic, staphylococcus, succinct, uncharacteristic, Cat_catc, aa, acceptancea";
        ...
        System.out.println("Start index of user word:\n" + RegEx.getWordStartIndex(text, "acceptancea"));
    }
}